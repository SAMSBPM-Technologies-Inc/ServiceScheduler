  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md card">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">Already have an account? <Link to={portalPath('/login')} className="text-primary-600 hover:underline">Login</Link></p>
      </div>
    </div>
  )
}
